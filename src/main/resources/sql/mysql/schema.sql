...
insert into vg_goods(id, name, description, price, image_normal, image_bigger) values(1, '贝壳', '贝壳，泛指软体动物的外壳。贝壳通常可以在海滩发现到，内里的生物通常已在冲上岸前消失。由于部份贝壳外形漂亮，有人会有收集贝壳的嗜好。', 3, 'images/goods/shell.png', 'images/goods/shell-bigger.png');
insert into vg_goods(id, name, description, price, image_normal, image_bigger) values(2, '玫瑰', '玫瑰（学名：Rosa rugosa）是蔷薇科蔷薇属植物，在日常生活中是蔷薇属一系列花大艳丽的栽培品种的统称。', 10, 'images/goods/rose.png', 'images/goods/rose-bigger.png');
insert into vg_goods(id, name, description, price, image_normal, image_bigger) values(3, '钻石', '钻石（英文：Diamond），化学中一般称为金刚石，钻石为经过琢磨的金刚石，金刚石则是指钻石的原石。', 100, 'images/goods/diamond.png', 'images/goods/diamond-bigger.png');

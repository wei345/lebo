...
<div class="control-group">
    <label for="guestAccountId" class="control-label">游客 账号ID:</label>

    <div class="controls">
        <input type="text" id="guestAccountId" name="guestAccountId" value="${setting.guestAccountId}"
               class="input-large required"/>
        游客可以无障碍地浏览视频, 但不能执行"写"操作, 如:收藏、转发、评论、发私信
    </div>
</div>
<%--查询时未使用该参数
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        用户按<input type="text" id="fastestRisingMinutes" name="fastestRisingMinutes"
                  value="${setting.fastestRisingMinutes}"
                  class="input-mini required"/>
        分钟内获得的红心数排序
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="radio" id="adsHotExpanded-true" name="adsHotExpanded"
               value="true" ${setting.adsHotExpanded ? "checked" : ""}/>
        <label for="adsHotExpanded-true" class="radio-label">展开</label>
        <input type="radio" id="adsHotExpanded-false" name="adsHotExpanded"
               value="false" ${setting.adsHotExpanded ? "" : "checked"}/>

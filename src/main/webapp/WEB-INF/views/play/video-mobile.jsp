...
<head>
    ...
    <style type='text/css'>
        ...
        #container {width:640px; margin: 0 auto; background-color:#E9E0D7;}
        #container .header {background-color:#55B4D6; padding:8px 18px;}
        #container .header .btn-dl-lebo {height:70px; display:inline-block; float:right; position:relative;}
        #container .header .btn-dl-lebo img {height:70px;}
        #video video { min-height: 640px; }
        #info {padding:36px 22px 15px;}
        #info .text, #lebo-sign .text {padding-left:16px; display:inline-block;  vertical-align: top;}
        #user-name {font-size:28px; color:#404040; margin-bottom: 10px;}
        #video-desc {font-size:24px; color:#898989;}
        #video-desc .channel { font-size:24px; color:#404040; padding-right: 5px; }
        .line{border-bottom: 1px #BDAFA0 solid;height: 1px;}
        #lebo-sign {padding:22px 22px 0;}
        #lebo-sign, .lebo-name {font-size:30px; font-weight: bold; color:#404040;}
        #lebo-sign, .desc {font-weight: normal; }
        #lebo-sign .desc {font-size:24px; color:#898989;}
        #dl-buttons {padding:22px;}
        #dl-buttons img{ width:220px; }
        #dl-buttons .btn-android { float:right; }
    </style>
</head>
<body>

...
<tags:form name="用户时间线" action="${ctx}/api/v1/statuses/userTimeline.json" method="GET">
    <tags:field name="count" optional="true"/>
    <tags:field name="maxId" optional="true"/>
    <tags:field name="sinceId" optional="true"/>
</tags:form>

<tags:example method="GET" url="http://localhost:8080/api/v1/statuses/userTimeline.json">
    [
    {

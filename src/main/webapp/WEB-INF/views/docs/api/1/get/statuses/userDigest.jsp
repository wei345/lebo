...
<tags:form name="精华" method="GET" action="${ctx}/api/1/statuses/userDigest.json">
...
<tags:example method="GET" url="http://localhost:8080/api/1/statuses/userDigest.json?count=1">
    [
        {

...
<p>
    返回值中的<code>directDownload</code>字段: true - 表示URL是直接下载地址(可能会有跳转)，false - 表示URL是网页地址，null或无此字段 - 表示URL内容不确定。
</p>
    ...
    [
        {
            ...
            imageUrl: "http://file.dev.lebooo.com/images/apps/lebo.png",

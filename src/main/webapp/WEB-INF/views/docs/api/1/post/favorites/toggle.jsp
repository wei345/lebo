...
<tags:form name="收藏切换" method="POST" action="${ctx}/api/1/favorites/toggle.json">
    <tags:field name="postId" value="51e6136ea0eedbd1aad37b71"/>
</tags:form>

<tags:example method="POST" url="http://localhost:8080/api/1/favorites/toggle.json?postId=51e6136ea0eedbd1aad37b71">
    {
